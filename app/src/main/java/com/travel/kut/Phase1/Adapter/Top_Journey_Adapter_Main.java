...
public class Top_Journey_Adapter_Main extends RecyclerView.Adapter<Top_Journey_Adapter_Main.SimpleViewHolder>{
    ...
    public Top_Journey_Adapter_Main(Context context) {
    ...
    @NonNull
    @Override
    public Top_Journey_Adapter_Main.SimpleViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.top_journey_places_item, viewGroup, false);
        return new Top_Journey_Adapter_Main.SimpleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Top_Journey_Adapter_Main.SimpleViewHolder simpleViewHolder, int i) {
